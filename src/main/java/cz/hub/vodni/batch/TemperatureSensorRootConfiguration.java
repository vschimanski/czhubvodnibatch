...
public class TemperatureSensorRootConfiguration extends DefaultBatchConfiguration {
    ...
    @Bean
    Job temperatureSensorJob(JobRepository jobRepository,
	...
	*/
    ...
    @Bean
    BatchProperties batchProperties(@Value("${spring.batch.jdbc.initialize-schema}") DatabaseInitializationMode initializationMode) {
